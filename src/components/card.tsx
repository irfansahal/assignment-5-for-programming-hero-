...
const CardStack = ({dataFetching , stackedData , setStackedData }) => {
    ...
    return(
       ...
       {fetchedData?.map((item, index:number)=>{
        return <div key={index} className="w-[600px] h-[270] md:w-[270px] md:h-[330px] rounded-2xl shadow-md bg-[#f5f0f3]">
                <div className="p-5 rounded-2xl  ">
                 ...
                 <div className=" pb-2 flex justify-around gap-3 pt-3">
                  ...
                  <div className="flex justify-center ">
                    <button className="px-15 py-3 rounded-2xl text-amber-50 font-bold bg-black"
                    onClick={()=>{
